...
We `lapply()` over this vector, each time generating a binary factor variable `BMRKR1_cut` and then tabulating the resulting statistics similar to [SFG3](../graphs/sfg03.qmd), this time including the treatment arms in the `subgroups` argument.
